...
payment_plugins="official-payment-wechat-native official-payment-alipay-page yingxue-payment-cloudcat-epay"
payments_only=false
...
build_payment_provider yingxue-payment-cloudcat-epay ./cmd/payment-cloudcat
