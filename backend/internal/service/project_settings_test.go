...
func newProjectSettingsTestService(t *testing.T) (*Service, *gorm.DB) {
	...
	if err := db.AutoMigrate(
		...
		&model.Shot{}, &model.ShotArtifact{}, &model.VoiceProfile{}, &model.Task{}, &model.Session{}, &model.Message{},
		&model.TaskLog{}, &model.Result{}, &model.Announcement{}, &model.AnnouncementImageDraft{},
	); err != nil {
		t.Fatal(err)
	}
